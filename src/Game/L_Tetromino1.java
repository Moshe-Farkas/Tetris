...
public class L_Tetromino1 extends Tetromino {
    /*
    [0]
    [1][*][3]
     */
    public L_Tetromino1() {
        ...
        blocks.add(new Block("blue-block", 0, 3));
        blocks.add(new Block("blue-block", 1, 3));
        blocks.add(new Block("blue-block", 1, 4));
        blocks.add(new Block("blue-block", 1, 5));
    }
