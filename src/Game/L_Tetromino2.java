...
public class L_Tetromino2 extends Tetromino {
    /*
            [0]
      [3][*][1]
    ...
    public L_Tetromino2() {
        ...
        blocks.add(new Block("orange-block", 0, 6));
        blocks.add(new Block("orange-block", 1, 6));
        blocks.add(new Block("orange-block", 1, 5));
        blocks.add(new Block("orange-block", 1, 4));
    }
