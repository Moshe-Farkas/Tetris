...
public class Skew_Tetromino2 extends Tetromino {
    ...
    public Skew_Tetromino2() {
        blocks = new LinkedList<>();
        blocks.add(new Block("red-block", 0, 3));
        blocks.add(new Block("red-block", 0, 4));
        blocks.add(new Block("red-block", 1, 4));
        blocks.add(new Block("red-block", 1, 5));
    }
