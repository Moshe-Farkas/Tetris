...
public class Straight_Tetromino extends Tetromino {
    /*
        [0][1][*][3]
     */
    public Straight_Tetromino() {
        blocks = new LinkedList<>();
        blocks.add(new Block("light-blue-block", 0, 3));
        blocks.add(new Block("light-blue-block", 0, 4));
        blocks.add(new Block("light-blue-block", 0, 5));
        blocks.add(new Block("light-blue-block", 0, 6));
    }
    ...
    private List<List<Point>> state0ToNeg1() {
        ...
        */
        ...
        basicRotation.add(new Point(blocks.get(0).col + 2, blocks.get(0).row + 2));
